      ...
      <div>
        <main>
          ...
          <div>
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    ...
                    <p>
                      Some options can be too long, so as a user, I want these lists to be shorten. I want to be able to click on a "See more" button to see the rest.
                    </p>
                    <ul>
                      <li>
                        Type
                    ...
                    <ol>
                      ...
                      <li>
                        Filter cards using the filters in the menu
                      </li>
                      <li>
                        If you decide to 
                        <b>
                         ...
                         build the mobile view (optional user story 
                        <b>
                          Mobile view
                        </b>
                        ), the layout of the cards and filters should still look nice on mobile. It is up to you how you want it to look like.
                      </li>
                    </ol>
                    <h5>
                      Notes & useful links:
            ...
            <h5>
              Optional (if you want to impress us):
            </h5>
            <ol>
              <li>
                <details
                ...
                >
                  ...
                  <div>
                    <p>
                      As a user I want to browse the application on a mobile device. Filters should be hidden by default and they should appear only when a button is clicked.
                    </p>
                    <p>
                      Filters should cover the all screen when opened.
                    </p>
                    <p>
                      The list of filters is too long, so I want the filters to be grouped in categories. I want every category to be a clickable button that when clicked, shows the list of all the options available
                    </p>
                    <h5>
                      Notes & useful links:
                    </h5>
            ...
            <ol>
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <p>
                      As a user I want to see all the cards in a carousel.
                    </p>
                    <p>
                      I want the carousel to be responsive.
                    </p>
                    <h5>
                      Tasks
                    </h5>
